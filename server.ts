  ...
  app.post('/api/trades/book-json', async (req, res) => {
    try {
      ...
      const newTrade: IRSwapTrade = {
        ...
        status: 'BOOKED',
        fixedLeg: (tradePayload.leg1?.legType === 'FLOATING' && tradePayload.leg2?.legType === 'FLOATING') ? undefined : (extracted.fixedLeg || tradePayload.fixedLeg),
        floatingLeg: extracted.floatingLeg || tradePayload.floatingLeg,
        leg1: tradePayload.leg1 || extracted.leg1,
        leg2: tradePayload.leg2 || extracted.leg2,
